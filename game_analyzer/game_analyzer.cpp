...
//	{
//		q = get_end(p);
//		q->next = static_cast<item*>(malloc(sizeof(*q)));
//		q = q->next;
//	}
//	else
//	{
//		q = static_cast<item*>(malloc(sizeof(*q)));
//		p = q;
//	}
//	q->next = NULL;
//	q->num = elem;
...
//	{
//		tmp = get_last(data);
//		tmp->next = static_cast<session*>(malloc(sizeof(*tmp)));
//		tmp = tmp->next;
//	}
//	else
//	{
//		tmp = static_cast<session*>(malloc(sizeof(*tmp)));
//		data = tmp;
//	}
//	tmp->next = NULL;
//	tmp->fd = fd;
...
//		if (pos == -1)
//			return;
//		str = static_cast<char*>(malloc(pos + 1));
